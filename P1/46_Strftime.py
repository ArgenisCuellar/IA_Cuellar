...
#Teniendo el objeto de timpo datetime con el now crea un objeto datetime con la fecha actual que tiene el sistema, incluyendo zona horaria

# Con los %x realizara cierta funcion para mostrar algun parametro en especifico del objeto datetime
